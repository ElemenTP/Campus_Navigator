...
LatLng verticalTract(LatLng point, LatLng pointa, LatLng pointb) {
  Offset a = Offset(
      cos(point.latitude / 90 * pi / 2) *
          cos(pi - (point.longitude) / 90 * pi / 2),
      cos(point.latitude / 90 * pi / 2) * sin((point.longitude) / 90 * pi / 2));
  Offset p1 = Offset(
...
void trailTract(LatLng point, LatLng pointa, LatLng pointb) {
